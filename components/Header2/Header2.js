                        ...
                        <div className="col-xl-3 col-lg-2 col-5">
                            <div className="site_logo">
                                <Link onClick={ClickHandler} className="site_link" href="/">
                                    <Image src={logo} alt="Site Logo – CyArm – IT Solutions & Cyber Security" />
                                    <Image src={logo2} alt="Site Logo – CyArm – IT Solutions & Cyber Security" />
                                    <span className="site_logo_text">CyArm</span>
                                </Link>
                            </div>
                        </div>
                                                            ...
                                                            <div className="site_author bg-primary">
                                                                <div className="author_box">
                                                                    ...
                                                                    <div className="author_box_content">
                                                                        ...
                                                                        <span className="author_designation text-white">CEO At CyArm</span>
                                                                    </div>
                                                                ...
                                                                <p className="mb-0 text-white">
                                                                    As a CEO at CyArm  I have been voice crying in the wilderness,  trying to make requirements clear, use every minute to deliver the  result, and not reinvent the wheel. Here at CyArm, I made that possible  for the clients.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
