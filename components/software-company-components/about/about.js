  ...
  return (
    <section className="about_and_case_section section_space section_decoration bg-dark" style={{ backgroundImage: `url(${'/images/backgrounds/bg_image_2.webp'})` }}>
          ...
          <div className="col-lg-7 order-lg-last">
            <div className="about_image_2">
              <div className="image_wrap">
                <Image src={about1} alt="CyArm - About" />
              </div>
            ...
            <div className="about_content">
              <div className="heading_block mb-0 text-white">
                ...
                <h2 className="heading_text">
                  CyArm <mark>Mission & Goal</mark>
                </h2>
                <p className="heading_description mb-0">
                  At CyArm, our mission is to empower businesses through innovative software solutions that streamline operations, foster growth, and drive success. With a commitment to excellence and customer satisfaction we strive.
                </p>
              </div>
            </div>
          </div>
            ...
            {Project.slice(6, 9).map((project, prj) => (
              <div className="case_study_block" key={prj}>
                <div className="case_study_image">
                  <Image src={project.pImg} alt="CyArm - Cases" />
                </div>
      ...
      <div className="decoration_item shape_image_1">
        <Image src={shape1} alt="CyArm Shape" />
      </div>
    </section>
  )
}
