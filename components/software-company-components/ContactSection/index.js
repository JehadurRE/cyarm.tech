    ...
    return (
        <section className="contact_section pb-80 bg-light section_decoration">
                            ...
                            <ul className="contact_method_list unordered_list_block">
                                <li>
                                    <a href="tel:+8801680636189">
                                        ...
                                        <span className="text">+880-1572-9186-72</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="mailto:contact@cyarm.tech">
                                        <span className="icon">
                                            <i className="fa-solid fa-envelope"></i>
                                        </span>
                                        <span className="text">contact@cyarm.tech</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#!">
                                        ...
                                        <span className="text">Adabor</span>
                                    </a>
                                </li>
                            </ul>
            ...
            <div className="decoration_item shape_image_2">
                <Image src={shape2} alt="CyArm Shape" />
            </div>
            <div className="decoration_item shape_image_3">
                <Image src={shape3} alt="CyArm Shape" />
            </div>
        </section>
    )
}
