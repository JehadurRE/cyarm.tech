                ...
                <div className="row">
                    <div className="col-lg-7">
                        <div className="it_solution_hero_content" style={{ backgroundImage: `url(${'/images/shapes/it_solution_hero_bg_1.svg'})` }}>
                            <div className="heading_focus_text mb-0 d-inline-flex align-items-center">👋 Hi We <span className="badge bg-secondary text-white">Are CyArm</span></div>
                            <h1>
                                ...
                                <li>
                                    <div className="review_short_info">
                                        <div className="d-flex">
                                            <Image src={icon} alt="CyArm - Trustpilot Review" />
                                            <span>4.8</span>
                                        </div>
                    ...
                    <div className="col-lg-5">
                        <ul className="it_solution_hero_images unordered_list">
                            <li>
                                <Image src={heroImg} alt="CyArm - IT Solution - Hero" />
                            </li>
                            <li>
                                <div className="worldwide_clients">
                                    ...
                                    <ul className="avatar_group unordered_list">
                                        <li>
                                            <Image src={avatar1} alt="CyArm - Avatar" />
                                        </li>
                                        <li>
                                            <Image src={avatar2} alt="CyArm - Avatar" />
                                        </li>
                                        <li>
                                            <Image src={avatar3} alt="CyArm - Avatar" />
                                        </li>
                                        <li>
                                            5k+
                                        </li>
